...
export default function SignupPage() {
  ...
  return (
    ...
    <div style={{ width: "100%", height: "100dvh", position: "relative", overflow: "hidden", background: "var(--lc-bg-page)", fontFamily: "var(--font-outfit, system-ui)" }}>
      <style>{STYLES}</style>
      ...
      <div className="map-wrap" style={{ position: "absolute", inset: 0, zIndex: 1 }}>
        <svg viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice"
          ...
          <path d="M 1022,726 L 1022,678 L 1094,678"
            stroke="var(--lc-bg-glass-mid)" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M 950,756 L 950,708 L 880,708"
            stroke="var(--lc-bg-glass)" strokeWidth="3.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          ...
          {/* Building blocks — downtown upper */}
          ...
          {[66,106,148,174,208,260,338,380,416,454,508,560,614,652,694].map(y => (
            <line key={`hl${y}`} x1="0" y1={y} x2="1288" y2={y} stroke="rgba(255,255,255,0.045)" strokeWidth="0.75" />
          ))}
          {[64,108,152,190,228,266,314,356,398,440,506,560,608,656,704,752,800,836,878,932,968,1016,1062,1106,1150,1194,1252].map(x => (
            <line key={`vl${x}`} x1={x} y1="0" x2={x} y2="900" stroke="rgba(255,255,255,0.045)" strokeWidth="0.75" />
          ))}
          {[120, 360, 600].map(y => (
            <line key={`hs${y}`} x1="0" y1={y} x2="1288" y2={y} stroke="var(--lc-bg-glass-hover)" strokeWidth="1.2" />
          ))}
          {[300, 540, 840, 1080].map(x => (
            <line key={`vs${x}`} x1={x} y1="0" x2={x} y2="900" stroke="var(--lc-bg-glass-hover)" strokeWidth="1.2" />
          ))}
          {[240, 480, 720].map(y => (
            <line key={`hp${y}`} x1="0" y1={y} x2="1288" y2={y} stroke="rgba(255,255,255,0.16)" strokeWidth="2" />
          ))}
          {[240, 480, 720, 960, 1200].map(x => (
            <line key={`vp${x}`} x1={x} y1="0" x2={x} y2="900" stroke="rgba(255,255,255,0.16)" strokeWidth="2" />
          ))}
          <path d="M 960,900 L 960,752 Q 960,724 986,714 L 1082,714"
            stroke="var(--lc-border-medium)" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M 1200,0 L 1200,608 Q 1200,624 1182,634 L 1088,680"
            stroke="rgba(255,255,255,0.2)" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          ...
          {/* Dispatch routes — Restaurant → FBO */}
          <path id="route-motion"
            d="M 1080,180 L 1200,180 L 1200,480 L 960,480 L 960,680 L 1140,680"
            fill="none" />
          <path d="M 1080,180 L 1200,180 L 1200,480 L 960,480 L 960,680 L 1140,680"
          ...
          {/* Secondary */}
          <path d="M 900,360 L 960,360 L 960,480 L 1200,480 L 1200,600"
          ...
          <path d="M 720,240 L 720,180 L 960,180 L 960,120"
          ...
          <circle r="3.5" fill="rgba(201,168,124,0.62)">
            <animateMotion dur="13s" begin="-1.1s" repeatCount="indefinite" calcMode="linear">
              <mpath href="#route-motion" />
            </animateMotion>
          </circle>
          <circle r="2" fill="rgba(201,168,124,0.32)">
            <animateMotion dur="13s" begin="-2s" repeatCount="indefinite" calcMode="linear">
              <mpath href="#route-motion" />
            </animateMotion>
          </circle>
          ...
          <g filter="url(#glow-pin)">
            <Pin cx={1080} cy={180} delay="0s" size={7} />
            <Pin cx={1140} cy={680} delay="1.4s" size={7} />
          </g>
          <circle cx={900} cy={360} r="4.5" stroke="rgba(201,168,124,0.44)" strokeWidth="1.2" fill="rgba(201,168,124,0.07)" />
          ...
          <path d="M 1074,172 Q 1074,178 1076,179 Q 1078,178 1078,172" stroke="#c9a87c" strokeWidth="1.3" fill="none" />
          <line x1="1084" y1="172" x2="1084" y2="188" stroke="#c9a87c" strokeWidth="1.5" strokeLinecap="round" />
          <path d="M 1084,172 Q 1088,175 1084,179" stroke="#c9a87c" strokeWidth="1.3" fill="none" strokeLinecap="round" />
          ...
          <text x="494" y="236" fill="var(--lc-border)" fontSize="8.5"
            fontFamily="system-ui" letterSpacing="0.09em">GRAND AVE</text>
          <text x="736" y="236" fill="var(--lc-border)" fontSize="8.5"
            fontFamily="system-ui" letterSpacing="0.09em">MIDTOWN BLVD</text>
      ...
      <div className="form-side" style={{
        ...
        width: "clamp(380px, 44%, 520px)",
        display: "flex", flexDirection: "column", justifyContent: "center",
        paddingLeft: "clamp(2rem, 5vw, 4.5rem)",
        paddingRight: "clamp(1.5rem, 3vw, 2.5rem)",
        paddingTop: "4.5rem", paddingBottom: "2.5rem",
        zIndex: 10, overflowY: "auto",
      }}>

        {/* Heading */}
        <div className="lx d2" style={{ marginBottom: "2rem" }}>
          ...
          <h1 style={{
            ...
            fontSize: "clamp(2rem, 3.2vw, 2.8rem)", fontWeight: 400, fontStyle: "italic",
            color: "var(--lc-text-primary)", letterSpacing: "-0.02em", lineHeight: 1.12, marginBottom: "0.65rem",
          }}>Create your account</h1>
          <p style={{
            fontFamily: "var(--font-outfit, system-ui)", fontSize: "0.95rem",
            color: "var(--lc-text-dim)", fontWeight: 300, letterSpacing: "0.01em", lineHeight: 1.6,
