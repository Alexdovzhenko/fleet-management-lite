      ...
      <div className="map-wrap" style={{ position: "absolute", inset: 0, zIndex: 1 }}>
        <svg viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice"
          ...
          <path d="M 1022,726 L 1022,678 L 1094,678"
            stroke="rgba(255,255,255,0.07)" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M 950,756 L 950,708 L 880,708"
            stroke="rgba(255,255,255,0.06)" strokeWidth="3.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          ...
          {[120, 360, 600].map(y => (
            <line key={`hs${y}`} x1="0" y1={y} x2="1288" y2={y} stroke="rgba(255,255,255,0.09)" strokeWidth="1.2" />
          ))}
          {[300, 540, 840, 1080].map(x => (
            <line key={`vs${x}`} x1={x} y1="0" x2={x} y2="900" stroke="rgba(255,255,255,0.09)" strokeWidth="1.2" />
          ))}
          {[240, 480, 720].map(y => (
          ...
          <path d="M 960,900 L 960,752 Q 960,724 986,714 L 1082,714"
            stroke="rgba(255,255,255,0.22)" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
