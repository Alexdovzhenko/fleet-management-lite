        ...
        {sent ? (
          ...
          <>
            ...
            <div className="lx d3" style={{
              ...
              <div style={{
                fontFamily: "var(--font-outfit, system-ui)", fontSize: "0.72rem",
                color: "rgba(200,212,228,0.4)", letterSpacing: "0.03em", marginBottom: "4px",
              }}>Link sent to</div>
              <div style={{
            ...
            <div className="lx d4" style={{
              fontFamily: "var(--font-outfit, system-ui)", fontSize: "0.72rem",
              color: "rgba(200,212,228,0.28)", letterSpacing: "0.03em", marginBottom: "2rem",
            }}>
              Didn&apos;t receive it?{" "}
              <button onClick={() => setSent(false)} style={{
                background: "none", border: "none", cursor: "pointer", padding: 0,
              }}>
                <span className="lk-dim">Try again</span>
              </button>
            </div>

            <div className="lx d5">
              <Link href="/auth/login" className="btn-primary" style={{ display: "block", textAlign: "center", textDecoration: "none" }}>
                Back to Sign In
              </Link>
            </div>
          </>
          ...
          <>
            ...
            <form onSubmit={handleSubmit}>
              <div className="lx d3 f" style={{ marginBottom: "2.6rem" }}>
                <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                  placeholder="Email address" required autoFocus className="fi" id="fp-email" />
            ...
            <div className="lx d5" style={{ display: "flex", alignItems: "center", gap: "1.2rem", margin: "1.8rem 0" }}>
