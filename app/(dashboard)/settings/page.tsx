  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl mb-8">
        ...
        {/* Profile card */}
        <div className="bg-white rounded-3xl border border-gray-100 shadow-[0_8px_40px_rgba(0,0,0,0.18)] overflow-hidden">
          ...
          <div className="flex">
            {/* Fleet column */}
            <div className="flex-1 p-6 pr-5 min-w-0">
              ...
              {visibleVehicles.length > 0 ? (
                <div className="grid grid-cols-2 gap-2.5">
                  {visibleVehicles.map(v => {
                    ...
                    return (
                      <div key={v.id} className="rounded-xl border border-gray-100 overflow-hidden">
                        ...
                        <div className="px-2.5 py-2 bg-white">
                          ...
                          <p className="text-[10px] text-gray-400 mt-0.5 truncate">
                            {[v.year, VEHICLE_TYPE_LABELS[v.type]].filter(Boolean).join(" · ")}
                          </p>
                        </div>
                      </div>
                    )
            ...
            {/* Contact column */}
            <div className="flex-1 p-6 pl-5 min-w-0">
          ...
          {/* About (below two columns if present) */}
          {form.about && (
            <div className="mx-6 mb-5 p-4 rounded-2xl bg-gray-50 border border-gray-100">
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">About</p>
