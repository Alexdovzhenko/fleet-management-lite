...
export function BillingSettingsForm() {
  ...
  return (
    <div className="flex gap-6 h-[calc(100vh-200px)]">
      {/* Left Panel - Form */}
      <div className="flex-[0_0_40%] overflow-y-auto pr-4 space-y-6">
        <div>
          <h2 className="text-xl font-semibold text-slate-900 mb-6">Billing Configuration</h2>
        </div>
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full h-9 px-3 rounded-lg border border-slate-200 bg-white text-sm text-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-500"
          >
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
